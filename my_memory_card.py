...
questions_list = [] 
questions_list.append(Question('Кто украл 4 литра кумыса?', 'ЭТО БЫЛ ОН - ДИО', 'скебеде туалет', 'мешок кирпичей', 'сэндвич'))
questions_list.append(Question('ты взял Болторез?', 'Да ', 'Нет', 'Мешок картошки', 'Асфальт мюсли телевизор'))
questions_list.append(Question('Кто такой ваш обэма?', 'Президент', 'Быдло', 'Байбеков', 'Капучино'))
questions_list.append(Question('Панки хой?', 'Горшок живой', 'я не панк', 'возможно частично', 'алгебра 7 класс'))
